...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s corebizcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  corebizcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded corebizcoin transaction") + "\n" +
              "  corebizcoin-tx [options] -create [commands]   " + _("Create hex-encoded corebizcoin transaction") + "\n" +
              "\n";
