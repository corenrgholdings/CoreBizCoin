...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/corebizcoin-project/corebizcoin>";
    const std::string URL_WEBSITE = "<https://corebizcoin.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("CoreBizCoin version %s\n", FormatFullVersion());
}
